...
var apiKeyHERE = "xJyVEAV83S41c79EjjrJU-cQOsiAOa5kU00s4anV6Ag";
...
// Opciones de autómoviles a seleccionar 
...
function SearchComponent(props) {
    ...
    function searchApi() {
        var fetch_link = "";
        fetch_link = `https://discover.search.hereapi.com/v1/discover?at=${props.userPosition.lat},${props.userPosition.lng}&lang=es&q=${search.query}&apiKey=${apiKeyHERE}`;
        fetch(fetch_link)
            .then(response => response.json())
            .then(data => {
                let places = [];
